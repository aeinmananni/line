...
export const CATEGORIES_LINK: LinksType[] = [
  { id: "sunglasses", title: "عینک", icon: <GiSunglasses />, link: "/" },
  { id: "watch", title: "ساعت", icon: <MdOutlineWatch />, link: "/" },
  { id: "ring", title: "انگشتر", icon: <GiRing />, link: "/" },
  { id: "bracelet", title: "دستبند", icon: <TbGitBranchDeleted />, link: "/" },
